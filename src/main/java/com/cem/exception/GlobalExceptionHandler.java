...
import static com.cem.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DoktorServisException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> authServiceHandler(DoktorServisException doktorServisException){
        return new ResponseEntity<>(createErrorMessage(doktorServisException, doktorServisException.getErrorType()),
                doktorServisException.getErrorType().getHttpStatus());
    }
